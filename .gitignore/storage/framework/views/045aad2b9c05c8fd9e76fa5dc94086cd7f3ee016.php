	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<div class="form-group">
		    	...
		    	<input type="text" class="form-control" name="email" placeholder="E mail  " value="<?php echo e(old('email')); ?>"  required >
...
</html><?php /**PATH E:\store\resources\views/placeorder.blade.php ENDPATH**/ ?>